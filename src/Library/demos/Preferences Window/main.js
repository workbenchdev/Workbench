...
const cs_switch = workbench.builder.get_object("cs_switch");
const appearance_page = workbench.builder.get_object("appearance_page");
const style_manager = Adw.StyleManager.get_default();

pref_window.set_visible_page(appearance_page);

print(style_manager.color_scheme);

cs_switch.active = style_manager.dark;

cs_switch.connect("state-set", (widget, state) => {
